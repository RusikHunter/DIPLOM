                    ...
                    <div className="account__row account__row--2 row">
                        ...
                        <div className="account__column account__column--2 column">
                            ...
                            <div className="account__plan-wrap">
                                ...
                                <Link to="/plan" className="account__link--plan">
                                ...
                                <div className="account__plan-block">
                                    {planValue === 'basic' &&
                                        <>
                                            <h6 className="account__plan-title">
                                                {translations[language].account.planBasic}
                                            </h6>
                                            <span className="account__plan-details">720p</span>
                                        </>
                                    }
                                    ...
                                    {planValue === 'standart' &&
                                        <>
                                            <h6 className="account__plan-title">
                                                {translations[language].account.planStandart}
                                            </h6>
                                            <span className="account__plan-details">1080p</span>
                                        </>
                                    }
                                    ...
                                    {planValue === 'premium' &&
                                        <>
                                            <h6 className="account__plan-title">
                                                {translations[language].account.planPremium}
                                            </h6>
