...
export default function Intro() {
    ...
    return (
        <section className='section section__intro intro' style={{ backgroundImage: `url(${moviesData.backDropPath})` }}>
            <div className="intro__inner container">
                <div className="intro__row row">
                    <div className="intro__column intro__column--1 column">
                        <img src={moviesData.posterPath} width={345} height={511} />
                    </div>
                    <div className="intro__column intro__column--2 column">
                        <div className="intro__title-wrap">
                            <h1 className='intro__title'>{moviesData.title}</h1>

                            <span className='intro__year'>{moviesData.year}</span>
                        </div>

                        <div className="intro__statistic">
                            <span className="intro__time">{moviesData.hours} {translations[language].intro.hours} {moviesData.minutes} {translations[language].intro.minutes}</span>

                            <span className="intro__censure">{moviesData.adult}</span>

                            <span className="intro__rating">IMDb: {moviesData.rating}</span>
                        </div>
                        ...
                        <div className="intro__tools">
                            ...
                            <button className="intro__button--like">
                                ...
                                <span className='intro__like--count'>{moviesData.likes}</span>
                            </button>
                            ...
                            <button className="intro__button--dislike">
                                ...
                                <span className='intro__dislike--count'>{moviesData.dislikes}</span>
                            </button>
                        </div>
                    </div>
                </div>
