                    ...
                    <div className="intro__row row">
                        ...
                        <div className="intro__column intro__column--2 column">
                            ...
                            <div className="intro__statistic">
                                ...
                                <span className="intro__rating">IMDb: 7.6</span>
                            </div>

                            <div className="intro__genre-list">
                                <div className="intro__genre">
                                    <span className="intro__genre-title">Фентезі</span>
                                </div>

                                <div className="intro__genre">
                                    <span className="intro__genre-title">Горор</span>
                                </div>

                                <div className="intro__genre">
                                    <span className="intro__genre-title">Містика</span>
                                </div>
                            </div>

                            <div className="intro__description-wrap">
                                <p className="intro__description">
                                    Готична історія про одержимість між переслідуваною молодою жінкою та жахливим вампіром, який закохався в неї, викликаючи невимовний жах.
                                </p>
                            </div>
